...
for index_test_class1 = [ 1 : 10 ]
  ...
  for index_test_class2 = [ 1 : 10 ]
    ...
    if index_test_class1 ~= index_test_class2
      ...
      train_features_limited = zeros( 16, 16, 4, total_number_of_training_sample );      
      ...
      test_features_limited = zeros( 16, 16, 4, total_number_of_testing_sample );      
...
save result_all_data_cifar_qpf.mat accuracy_all
