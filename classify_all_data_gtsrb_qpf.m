...
for index_test_class1 = [ 1 : 43 ]
  for index_test_class2 = [ 1 : 43 ]
    ...
    if index_test_class1 ~= index_test_class2
      ...
      X_test  = test_features_limited;
      y_test  = test_labels_limited;
      
      %% perform QPF
      Z_train = zeros( 16, 16, 4, total_number_of_training_sample );
      for index_image = 1 : total_number_of_training_sample
      ...
      Z_test = zeros( 16, 16, 4, total_number_of_testing_sample );
      for index_image = 1 : total_number_of_testing_sample
        
        current_XTest = X_test( :, :, index_image );
        current_output = zeros( 16, 16, 4 );
        ...
        Z_test( :, :, :, index_image ) = current_output;
...
save result_all_data_gtsrb_qpf.mat accuracy_all
