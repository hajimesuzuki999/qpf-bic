...
for index_test_class1 = [ 1 : 10 ]
  ...
  for index_test_class2 = [ 1 : 10 ]
    ...
    if index_test_class1 ~= index_test_class2
      ...
      %% perform QPF
      Z_train = zeros( 14, 14, 4, total_number_of_training_sample );
      ...
      Z_test = zeros( 14, 14, 4, total_number_of_testing_sample );
...
save result_all_data_mnist_qpf.mat accuracy_all
