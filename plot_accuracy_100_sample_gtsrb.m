...
load result_100_sample_gtsrb_nn.mat accuracy_all
...
index_all = [ 1 : 43 * 43 ].';
index_remove = zeros( 43, 1 );

for index_diagonal = 1 : 43

  index_remove( index_diagonal ) = sub2ind( [ 43 43 ], index_diagonal, index_diagonal );
...
load result_100_sample_gtsrb_qpf.mat accuracy_all
...
print -dpng -r300 plot_accuracy_100_sample_gtsrb.png